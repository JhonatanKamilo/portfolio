      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto flex flex-col items-center gap-12">
          ...
          <a
            ...
            className="group relative flex items-center gap-4 bg-[var(--color-surface)]/30 hover:bg-[var(--color-surface)]/60 border border-[var(--color-border)]/20 hover:border-[var(--color-accent)]/50 rounded-2xl px-8 py-5 transition-all duration-300 backdrop-blur-md"
          >
            ...
            <svg className="w-6 h-6 text-[var(--color-text)]/70 group-hover:text-[var(--color-accent)] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[var(--color-text)] font-mono text-sm sm:text-base font-medium">
                {emailContact}
              </span>
            </div>

            <svg className="w-5 h-5 ml-4 text-[var(--color-text)]/20 group-hover:text-[var(--color-accent)] group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
