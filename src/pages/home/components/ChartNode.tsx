  ...
  return (
    <div className={`absolute ${positionClasses} z-10 w-6 h-6`}>
      <div className="relative group w-full h-full">
        ...
        >
          <h3 className="text-sm font-bold tracking-widest uppercase text-[var(--color-text)]/90 drop-shadow-sm">
        ...
        >
          ...
          <h4 className="text-[var(--color-accent)] text-[10px] font-bold tracking-[0.2em] uppercase mb-1 text-left">
            {subtitle}
          </h4>
